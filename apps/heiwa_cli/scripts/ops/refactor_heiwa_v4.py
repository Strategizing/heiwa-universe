...
REPLACEMENTS = {
    ...
    "packages/heiwa_sdk/heiwa_sdk": "packages/heiwa_sdk",
    "packages/heiwa_protocol/heiwa_protocol": "packages/heiwa_protocol",
    "from heiwa_protocol.protocol": "from heiwa_protocol.protocol",
    "from heiwa_sdk": "from heiwa_sdk", # SDK folder renamed but package name might stay
