...
rm -f "$AGENTS_DIR/ai.heiwa.nats.plist"
...
<dict>
  ...
  <array>
    ...
    <string>$ROOT/apps/heiwa_cli/scripts/ops/worker_manager_daemon.sh</string>
  </array>
...
launchctl list | grep -E 'ai.heiwa.worker-manager' || true
