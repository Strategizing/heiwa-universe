...
def main() -> int:
    ...
    remaining_critical = [
        ...
        "apps/swarm-hub/main.py",
        "apps/swarm-hub/config.py",
        "apps/heiwa-cli/scripts/agents/worker_manager.py",
        "apps/heiwa-cli/scripts/agents/wrappers/codex_exec.sh",
        "apps/heiwa-cli/scripts/agents/wrappers/openclaw_exec.sh",
        "apps/heiwa-cli/scripts/agents/wrappers/picoclaw_exec.py",
        "apps/heiwa-cli/scripts/agents/wrappers/ollama_exec.py",
    ]
