...
class HeiwaShell:
    ...
    async def handle_thought(self, msg):
        ...
        if data.get("encrypted") and content.startswith("[ENCRYPTED]: "):
            content = "[Secure Thought Captured]"

        console.print(f"[italic cyan]🧠 {agent}[/italic cyan] [dim]({task_id}): {content[:120]}...[/dim]")
    ...
    async def show_nodes(self):
        ...
        # In future, pull from a 'heartbeat' register in DB
    ...
    async def run(self):
        ...
        console.print(Align.center(Panel(
            Text.assemble(
                ...
                ("Mesh Brain: ", "bold"), ("100.116.86.118 ", "cyan"), ("| Node: ", "bold"), (f"{self.node_id}", "green")
            ),
