...
wsl bash -c "cd ~/heiwa && chmod +x node/cli/scripts/ops/*.sh && ./node/cli/scripts/ops/setup_wsl_node.sh"
...
Write-Host "👉 Finally, run this in WSL: cd ~/heiwa && ./node/cli/scripts/ops/start_worker_stack.sh" -ForegroundColor White
