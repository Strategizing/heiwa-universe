...
from libs.heiwa_sdk.routers.products import router as product_router
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "heiwa-hub"}
...
def whoami(x_auth_token: str = Header(None)):
    return {"authenticated": True, "mode": "operator_or_node", "service": "heiwa-hub"}
